...
import { Heart, CreditCard, Gift, Share2 } from 'lucide-react';
    ...
    <section id="donate" className="py-20 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <h2 className="text-4xl font-bold mb-4">Help Us Save More Lives</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-all text-center group">
            ...
            <p className="text-slate-400 text-sm mb-6">Directly transfer to our NGO account. Tax exempted under 80G.</p>
            <div className="bg-black/30 p-4 rounded-lg text-left text-sm font-mono text-slate-300">
              <p>Acc Name: Arham Yuva Seva Group</p>
              <p>Acc No: 50200023412345</p>
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-all text-center group">
            ...
            <p className="text-slate-400 text-sm mb-6">Adopt the operational cost of one ambulance for a month or year.</p>
            <button className="w-full py-3 rounded-lg bg-blue-600 hover:bg-blue-700 font-semibold transition-colors">
          ...
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-all text-center group">
            ...
            <p className="text-slate-400 text-sm mb-6">We accept medicine, old clothes, food, and medical equipment.</p>
            <button className="w-full py-3 rounded-lg bg-green-600 hover:bg-green-700 font-semibold transition-colors">
              View Wishlist
            </button>
          </div>
        </div>
