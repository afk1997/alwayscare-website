  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt=""
        className="absolute left-0 top-0 w-[600px] opacity-[0.04] pointer-events-none select-none"
        aria-hidden="true"
      />
      <img
        src="https://framerusercontent.com/images/g690a9Fxc6Y5G69sPCSKq4vjw.png"
        alt=""
        className="absolute right-0 bottom-0 w-[500px] opacity-[0.03] pointer-events-none select-none rotate-180"
        aria-hidden="true"
      />

      {/* Decorative blobs */}
      <div className="absolute top-0 right-1/4 w-80 h-80 bg-red-600/5 rounded-full blur-3xl" />
