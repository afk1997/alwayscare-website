...
const socialLinks = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/arhamalwayscare',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/alwayscareindia/',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'X',
    href: 'https://x.com/AlwaysCareIndia',
    icon: (
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@ArhamAlwaysCare',
    icon: (
  ...
  {
    label: 'WhatsApp',
    href: 'https://whatsapp.com/channel/0029Vb6iSj8I7BeIaONOIo2N',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
